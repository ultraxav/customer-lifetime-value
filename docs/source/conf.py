...
# customer_lifetime_value documentation build
...
from customer_lifetime_value import __version__ as release
...
htmlhelp_basename = "customer_lifetime_valuedoc"
...
latex_documents = [
    (
        master_doc,
        "customer_lifetime_value.tex",
        "customer_lifetime_value Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "customer_lifetime_value",
        "Project customer_lifetime_value codebase.",
        "Data-Science",
    )
]
